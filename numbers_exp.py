...
if __name__ == '__main__':
    opts = get_opts()
    ##################################################################################################################
    temps_path = './results_save/c100/numbers/temps'
    opts.result_path = './results_save/c100/numbers/acc'
    opts.txt_path = './results_save/c100/numbers/txt'
    ...
    run = 'c100_numbers_origin_blend_r18_0.015_0_0'
    # run = 'c100_numbers_clip_blend_r18_0.015_0_0'

    print('running numbers: {}'.format(run))
